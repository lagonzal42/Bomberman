	...
	public void update(Observable o, Object arg) {
		...
		else
		{
			...
			switch (gelMota)
			{
				...
				case ETSAIAIESKUMA:
					this.setIrudia("/bista/Sprites/doria1.png");
					break;
				case ETSAIAIEZKERRA:
					this.setIrudia("/bista/Sprites/doria2.png");
					break;
				case IRABAZI:
					//this.setIrudia("/bista/Sprites/miniBlast1.gif");
					/*animazioa = new Timer(2000, e -> {
				...
				case ULTRABONBA:
					...
					break;
				case JOKALARIABURBUILA:
					this.setIrudia("/bista/Sprites/"+color+"Burbuila.png");
					break;
				case BURBUILASUA:
					this.setIrudia("/bista/Sprites/miniBlast4.gif");
					break;
				default:
